  ...
  <table border="0" width="90%">
    <tr>
      ...
      <td width="70%">
        ...
        <p>Hi, I'm <b>Kritika</b>.</p>
        <p>B.Tech student building software, AI systems, and things that make the internet slightly more interesting.</p>
        <p><b>Focus:</b> Java • DSA • AI • GenAI • Backend • Computer Vision</p>
      </td>
    </tr>
  </table>
</div>
  ...
  <table border="1" bordercolor="#00FFFF" width="90%" style="border-collapse: collapse; background-color: #0d1117;">
    <tr>
      <td width="50%" align="center">
        ...
        <!-- PLACEHOLDER: Update GitHub link if needed -->
